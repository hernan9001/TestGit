...
<span style="color:red;">**Response 1.1:** We thank the commenter for inspecting the released data and code and for identifying this discrepancy. We acknowledge this reporting error and confirm that the model was trained on twelve predictors, not fourteen, as shown in **Figure 1b** of the pipeline.</span>
...
<span style="color:red;">**Response 1.2:** We thank the commenter for identifying this inconsistency.</span> 
